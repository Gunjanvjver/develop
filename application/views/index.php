					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
							<ul class="nav nav-tabs" id="tabContent">
                                                    <li class="active"><a href="#login_body" data-toggle="tab">Log In</a></li>
                                                    <li><a href="#signup_body" data-toggle="tab">Sign Up</a></li>                                   
                                                </ul>
                                                    <div class="tab-content">
									<div class="login-right tab-pane active" id="login_body">
										<h3>Sign In with your account</h3>
										<form>
											<div class="sign-in">
												<h4>Email :</h4>
												<input type="email" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Type here';}" required="">	
											</div>
											<div class="sign-in">
												<h4>Password :</h4>
												<input type="password" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-warning" data-dismiss="modal">Close</button>
                                                                        ...
                                                                        <div class="login-right tab-pane" id="signup_body">
										<h3>Sign Up with your account</h3>
										<form id="signup_form" method="post">
                                                                                        <div class="name">
												<h4>Name :</h4>
												<input type="text" value="" required="" name="name" id="name" maxlength="50" size="50">	
											</div>
											<div class="email">
												<h4>Email :</h4>
												<input type="email" value="" required="" name="email" id="email" maxlength="255" size="255">	
											</div>
											<div class="password">
												<h4>Password :</h4>
												<input type="password" value="" required="" name="password" id="password">
												
											</div>
                                                                                        <div class="phone">
												<h4>Mobile :</h4>
												<input type="text" value="" required="" name="mobile" id="moblie" maxlength="16" size="16">
